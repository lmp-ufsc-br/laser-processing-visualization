...
function Solidification() {
  return (
    <div>
      <h5>Simulação de Evolução Microestrutural</h5>
      <p>
        Introdução sobre o conteúdo. Vivamus sagittis lacus vel augue laoreet
        rutrum faucibus dolor auctor. Duis mollis, est non commodo luctus, nisi
