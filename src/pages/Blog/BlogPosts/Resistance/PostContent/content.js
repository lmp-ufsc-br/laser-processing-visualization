...
O teste teve como objetivo desenvolver o conhecimento necessário para a realização
de simples simulações de deformação por meio de um software de análises de elementos finitos.
O ambiente escolhido para executar a simulação foi o Ansys Mechanical da empresa norte-americana Ansys Inc.
Para isso, foram definidas restrições e requisitos que o teste precisaria atender.
